namespace Forum.App.Menus
{
    ...
    public class AddReplyMenu : Menu, ITextAreaMenu, IIdHoldingMenu
    {
        ...
        public AddReplyMenu(ILabelFactory labelFactory, ITextAreaFactory textAreaFactory, IForumReader reader, IPostService postService, ICommandFactory commandFactory)
        {
